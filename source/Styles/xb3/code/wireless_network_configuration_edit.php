...
<div id="content">
	...
	<div id="educational-tip">
		...
		<p class="hidden"><strong>Network Name (SSID):</strong> Identifies your home network from other nearby networks. Your default name can be found on the bottom label of the Gateway, but can be changed for easier identification.</p>
		 <?php if("5"==$radio_band):?>
		 <p class="hidden"><strong>Mode:</strong>  <?php echo $radio_band; ?> GHz operates in <?php echo $support_mode_5g; ?> modes. Unless you have older Wi-Fi devices that use only 'b' mode, use the default 802.11 g/n for faster performance.</p>
		<?php else: ?>
		 <p class="hidden"><strong>Mode:</strong>  <?php echo $radio_band; ?> GHz operates in <?php echo $support_mode_2g; ?> modes. Unless you have older Wi-Fi devices that use only 'b' mode, use the default 802.11 g/n for faster performance.</p>
		<?php endif; ?>
